...
test('verified clubs outside 50 km are excluded from nearby without affecting manual search',()=>{
 ...
 assert.match(reviewedClubsLocationSummary(distant),/búsqueda manual sigue disponible/);
});
