...
export function AccountPanel({ view, highContrast, onHighContrastChange, notificationsEnabled, onNotificationsEnabledChange, golfInsights, onOpenStats, onOpenAccount }: AccountPanelProps) {
  ...
  return <>
    ...
    <section className="card"><div className="sectionTitle"><div><h2>Beta Pro</h2><p>Todas las funciones habilitadas para testers, sin cobro.</p></div></div><Link className="secondary big" href="/membership">Ver beneficios de membresía</Link></section>
