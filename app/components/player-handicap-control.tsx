...
export function PlayerHandicapControl({ player, onChange }: {
  ...
  if (!canEditGuestHandicap(player)) return <div className="accountHandicapLocked" aria-label={`HCP de ${player.name} bloqueado`}>
    ...
    {player.handicap === null && player.handicapIndex === undefined && <small>HCP / Index pendiente en el perfil del jugador.</small>}
  </div>;
