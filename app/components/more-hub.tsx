...
type ToolIcon = "course" | "bag" | "hcp" | "fit" | "gps" | "help" | "settings";
...
export function MoreHub({ hasActiveRound, onOpenCourses, onOpenEquipment, onOpenHandicap, onOpenFitting, onOpenGps, onOpenHelp, onOpenSettings }: MoreHubProps) {
  const tools = [
