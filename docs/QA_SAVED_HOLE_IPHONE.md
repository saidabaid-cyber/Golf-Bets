...
> **Evidencia histórica; no abrir el host Beta indicado por el reporte original.** La única URL actual de owner QA es `https://dev.thebackyard.com.mx` desde `integration/backyard-current`.
...
URL histórica retirada: Beta (no usar). URL canónica actual: https://dev.thebackyard.com.mx
