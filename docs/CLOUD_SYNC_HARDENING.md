...
- La capacidad del esquema se obtiene del documento OpenAPI autenticado de PostgREST. El fallback temporal para el esquema anterior ya no consulta columnas ausentes ni provoca un 400 esperado en cada sincronización.
