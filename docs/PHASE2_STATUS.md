...
Begin Phase 2B from commit `58842c9`: extend the existing course/provider foundation with paginated UX, deterministic Course Handicap, GPS and export contracts.
