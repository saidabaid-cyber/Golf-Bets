...
Begin Phase 2C from commit `97c768b`: add live-round permissions, provider-neutral realtime, idempotent offline operations, provisional scoreboard, activity and notification foundations.
