...
10. **Preview:** Vercel creó automáticamente previews de `codex-dev`. Alias de revisión: `https://golf-bets-git-codex-dev-saha8.vercel.app`. La URL inmutable y el estado del último preview se verifican al cerrar.
