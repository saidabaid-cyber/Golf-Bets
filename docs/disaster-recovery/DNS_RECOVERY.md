...
| dev.thebackyard.com.mx | Canonical QA branch domain for integration/backyard-current | Keep bound only to the canonical Preview branch; never substitute an immutable deployment URL |
