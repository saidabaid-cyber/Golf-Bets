...
export const COMPLETION_LABELS: Record<CompletionSection, string> = { personal: "Datos personales", username: "Nombre de usuario", golf: "Información de golf", handicap: "Fuente de hándicap", equipment: "Equipo / bastones", ball: "Bola", fitting: "Fitting" };
...
export function profileCompletion(input: { displayName?: string | null; givenName?: string | null; familyName?: string | null; username?: string | null; handedness?: string | null; homeClub?: string | null; preferredTee?: string | null; indexEnabled: boolean; equipment: EquipmentProfile | null; choices: CompletionChoices }) {
 ...
 const facts: Record<CompletionSection, boolean> = {
  ...
  golf: Boolean(input.handedness && (input.homeClub?.trim() || input.preferredTee?.trim())),
