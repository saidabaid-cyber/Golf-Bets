...
export const BET_HELP: Record<BetHelpKind, BetHelpCopy> = {
  ...
  vipers: {
    title: "🐍 Víboras",
    what: "Apuesta de putting con una bolsa para H1–H9 y otra independiente para H10–H18. Cada 3-putt o más genera una Víbora en la vuelta correspondiente.",
    how: ["Cada vez que un jugador hace 3 putts o más se agrega una Víbora a la bolsa de esa vuelta.", "Al cerrar H9 se liquida la primera bolsa y al cerrar H18 se liquida la segunda. Si hay presión, solo el valor por evento de H10–H18 se multiplica."],
    ...
    example: "Con valor de $100 y presión 2x, 10 Víboras en H1–H9 forman una bolsa de $1,000 y 10 en H10–H18 forman otra de $2,000. El keeper de cada vuelta paga esa bolsa a cada rival.",
  },
  camels: {
    title: "🐫 Camellos",
    what: "Apuesta de bunker con una bolsa para H1–H9 y otra independiente para H10–H18.",
    how: ["Cada vez que ocurre la condición configurada de Camello se suma uno a la bolsa de esa vuelta.", "Al cerrar H9 se liquida la primera bolsa y al cerrar H18 la segunda. Si hay presión, solo el valor por evento de H10–H18 se multiplica."],
  ...
  fish: {
    title: "🐟 Peces",
    what: "Apuesta relacionada con agua con una bolsa para H1–H9 y otra independiente para H10–H18.",
    how: ["Cada vez que ocurre la condición configurada de Pez se suma uno a la bolsa de esa vuelta.", "Al cerrar H9 se liquida la primera bolsa y al cerrar H18 la segunda. Si hay presión, solo el valor por evento de H10–H18 se multiplica."],
