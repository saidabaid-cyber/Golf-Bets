...
export const BET_HELP: Record<BetHelpKind, BetHelpCopy> = {
  ...
  vipers: {
    ...
    how: ["Cada vez que un jugador hace 3 putts o más en un hoyo se agrega una Víbora a la bolsa.", "Todas las Víboras permanecen acumuladas hasta terminar la ronda. Cada evento de H10–H18 usa el multiplicador de segunda vuelta configurado."],
    rules: ["Se queda con todas las Víboras el jugador que haga el último 3-putt o más de la ronda.", "Si varios jugadores generan Víbora en ese mismo último hoyo, se las queda quien deje su último putt más cerca del hoyo.", "Quien se queda con las Víboras paga a cada rival el valor total acumulado; la bolsa no se reinicia en H10."],
    example: "Con valor de $100 y segunda vuelta 3x, dos Víboras en H1–H9 y dos en H10–H18 forman una bolsa de $800. Pedro hace la última y paga $800 a cada rival.",
  },
  camels: {
    title: "🐫 Camellos",
    what: "Apuesta de bunker en la que cada Camello registrado se agrega a una bolsa acumulada.",
    how: ["Cada vez que ocurre la condición de Camello se suma uno.", "Los Camellos continúan acumulándose durante toda la ronda. Cada evento de H10–H18 usa el multiplicador de segunda vuelta configurado."],
    rules: ["El último jugador que genera un Camello se queda con todos los acumulados.", "Quien se queda con los Camellos paga a cada uno de los demás jugadores el valor total acumulado; la bolsa no se reinicia en H10."],
    example: "Con valor de $100 y segunda vuelta 2x, dos Camellos en H1–H9 y dos en H10–H18 forman una bolsa de $600. Daniel genera el último y paga $600 a cada rival.",
  },
  fish: {
    title: "🐟 Peces",
    what: "Apuesta relacionada con agua en la que cada Pez registrado se agrega a una bolsa acumulada.",
    how: ["Cada vez que ocurre la condición de Pez se suma uno.", "Todos los Peces permanecen acumulados durante la ronda. Cada evento de H10–H18 usa el multiplicador de segunda vuelta configurado."],
    rules: ["El último jugador que genera un Pez se queda con todos los Peces acumulados.", "Quien se los queda paga a cada uno de los demás jugadores el valor total acumulado; la bolsa no se reinicia en H10."],
    example: "Con valor de $100 y segunda vuelta 5x, un Pez en H1–H9 y otro en H10–H18 forman una bolsa de $600. Said genera el último y paga $600 a cada rival.",
  },
  loba: {
    title: "🐺 Loba",
