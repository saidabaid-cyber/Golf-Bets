...
export const BET_HELP: Record<BetHelpKind, BetHelpCopy> = {
  ...
  foursome: {
    ...
    rules: ["Las parejas pueden cambiar por tramos.", "La modalidad puede pagar un fijo por tramo, puntos/patada o ambos. La presión configurada multiplica únicamente la segunda vuelta jugada."],
  ...
  polla: {
    ...
    rules: ["Polla 1ª vuelta, Polla 2ª vuelta y Polla 18 hoyos son componentes independientes.", "La primera vuelta son los primeros nueve hoyos jugados y la segunda los nueve siguientes. Si hay empate en el mejor total, los ganadores dividen el pozo."],
  ...
  vipers: {
    title: "🐍 Víboras",
    what: "Apuesta de putting con una bolsa para la primera vuelta jugada y otra independiente para la segunda. Cada 3-putt o más genera una Víbora en la vuelta correspondiente.",
    how: ["Cada vez que un jugador hace 3 putts o más se agrega una Víbora a la bolsa de esa vuelta.", "La primera bolsa se liquida al completar los primeros nueve hoyos jugados y la segunda al completar los nueve siguientes. Si hay presión, solo el valor por evento de la segunda vuelta jugada se multiplica."],
    rules: ["En cada vuelta se queda con la bolsa quien haga la última Víbora de esa vuelta.", "Si varios jugadores generan Víbora en el mismo último hoyo de esa vuelta, se la queda quien tenga la menor distancia final al hoyo.", "Quien se queda con una bolsa paga su valor completo a cada rival. Las dos vueltas se liquidan por separado."],
    example: "Saliendo por H10, con valor de $100 y presión 2x, 10 Víboras en H10–H18 forman una bolsa de $1,000 y 10 en H1–H9 forman otra de $2,000. El keeper de cada vuelta paga esa bolsa a cada rival.",
  },
  camels: {
    title: "🐫 Camellos",
    what: "Apuesta de bunker con una bolsa para la primera vuelta jugada y otra independiente para la segunda.",
    how: ["Cada vez que ocurre la condición configurada de Camello se suma uno a la bolsa de esa vuelta.", "Cada bolsa se liquida al completar su mitad del recorrido. Si hay presión, solo el valor por evento de la segunda vuelta jugada se multiplica."],
    rules: ["En cada vuelta se queda con la bolsa el último jugador que genera un Camello en esa vuelta.", "Si varios jugadores empatan en el mismo último hoyo, se usa la selección de desempate de esa vuelta.", "Quien se queda con una bolsa paga su valor completo a cada rival. Las dos vueltas no se mezclan."],
    example: "Con valor de $100 y presión 2x, tres Camellos en la primera vuelta forman una bolsa de $300 y tres en la segunda forman otra de $600. Cada keeper paga la bolsa de su vuelta a cada rival.",
  },
  fish: {
    title: "🐟 Peces",
    what: "Apuesta relacionada con agua con una bolsa para la primera vuelta jugada y otra independiente para la segunda.",
    how: ["Cada vez que ocurre la condición configurada de Pez se suma uno a la bolsa de esa vuelta.", "Cada bolsa se liquida al completar su mitad del recorrido. Si hay presión, solo el valor por evento de la segunda vuelta jugada se multiplica."],
    rules: ["En cada vuelta se queda con la bolsa el último jugador que genera un Pez en esa vuelta.", "Si varios jugadores empatan en el mismo último hoyo, se usa la selección de desempate de esa vuelta.", "Quien se queda con una bolsa paga su valor completo a cada rival. Las dos vueltas no se mezclan."],
    example: "Con valor de $200 y presión 3x, dos Peces en la primera vuelta forman una bolsa de $400 y dos en la segunda forman otra de $1,200. Cada keeper paga la bolsa de su vuelta a cada rival.",
  },
  loba: {
    title: "🐺 Loba",
